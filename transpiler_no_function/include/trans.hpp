...
private:
    string translate_expr(json &expr, UDFType *expected_type, bool query_is_assignment);
    ...
    string translate_query(json &query, UDFType *expected_type, bool query_is_assignment);
