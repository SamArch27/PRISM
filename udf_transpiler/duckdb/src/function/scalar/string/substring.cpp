...
void SubstringFun::RegisterFunction(BuiltinFunctions &set) {
	...
	substr.AddFunction(ScalarFunction({LogicalType::VARCHAR, LogicalType::BIGINT, LogicalType::BIGINT},
	                                  LogicalType::VARCHAR, SubstringFunction<SubstringUnicodeOp>, ScalarFunctionInfo("SubstringUnicodeOp::SubString", true), nullptr, nullptr,
	                                  SubstringPropagateStats));
	substr.AddFunction(ScalarFunction({LogicalType::VARCHAR, LogicalType::BIGINT}, LogicalType::VARCHAR,
	                                  SubstringFunction<SubstringUnicodeOp>, ScalarFunctionInfo("SubstringUnicodeOp::SubString", {ScalarFunctionInfo::SubStringAutoLengthWrapper}, true), nullptr, nullptr,
	                                  SubstringPropagateStats));
