...
void ConcatFun::RegisterFunction(BuiltinFunctions &set) {
	...
	concat_op.AddFunction(
	    ScalarFunction({LogicalType::VARCHAR, LogicalType::VARCHAR}, LogicalType::VARCHAR, ConcatOperator, ScalarFunctionInfo("ConcatOperator", {ScalarFunctionInfo::VectorFrontWrapper, ScalarFunctionInfo::ConstantVectorWrapper}, true, true)));
	concat_op.AddFunction(ScalarFunction({LogicalType::BLOB, LogicalType::BLOB}, LogicalType::BLOB, ConcatOperator, ScalarFunctionInfo("ConcatOperator", {ScalarFunctionInfo::VectorFrontWrapper, ScalarFunctionInfo::ConstantVectorWrapper}, true, true)));
