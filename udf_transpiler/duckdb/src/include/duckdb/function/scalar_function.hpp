...
public:
    ...
    */
	...
	DUCKDB_API ScalarFunctionInfo(std::string cpp_name, std::vector<SpecialValueHandling> special_handling, bool place_holder) : cpp_name(cpp_name), special_handling(special_handling) {}
